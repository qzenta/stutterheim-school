  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="text-gray-600 mb-2">
        We offer a broad curriculum of 20+ subjects to ensure every learner can find their strengths
        and pursue their passions.
      </p>
      <p className="text-sm text-gray-400 mb-10">
        {/* TODO: confirm final subject list with school before launch */}
        Subject list to be confirmed with Dr Haruna before launch.
      </p>
