...
export default function HomePage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-[#1A3A8F] text-white py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#E8A020] font-semibold text-sm uppercase tracking-widest mb-3">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="px-8 py-3 bg-[#E8A020] text-[#1A3A8F] font-bold rounded hover:bg-amber-400 transition-colors text-lg"
            >
              Apply Now
            </Link>
            <Link
              href="/about"
              className="px-8 py-3 border border-white text-white font-semibold rounded hover:bg-white hover:text-[#1A3A8F] transition-colors text-lg"
            >
              Learn More
            </Link>
          </div>
      ...
      <section className="bg-white border-b border-gray-100 py-12 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
          {stats.map((s) => (
            <div key={s.label}>
              <p className="text-4xl font-bold text-[#1A3A8F]">{s.value}</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-[#1A3A8F] mb-4">Our Mission</h2>
          ...
          <div className="mt-6 w-16 h-1 bg-[#E8A020] mx-auto rounded" />
        </div>
      </section>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-[#1A3A8F] text-center mb-10">Why Choose SIS?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={p.title} className="bg-[#F7F8FA] rounded-lg p-6 border border-gray-100">
                <div className="w-10 h-1 bg-[#E8A020] rounded mb-4" />
                <h3 className="font-bold text-[#1A3A8F] mb-2">{p.title}</h3>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-[#1A3A8F] text-center mb-8">Activities & Programmes</h2>
          <ul className="flex flex-wrap justify-center gap-3">
            {activities.map((a) => (
              <li key={a} className="bg-[#1A3A8F] text-white px-4 py-2 rounded-full text-sm font-medium">
                {a}
              </li>
            ))}
          </ul>
      ...
      {/* Admissions CTA */}
      <section className="bg-[#1A3A8F] text-white py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-[#E8A020] font-semibold text-sm uppercase tracking-widest mb-2">Limited Spaces</p>
